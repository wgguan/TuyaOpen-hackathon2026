...
#if defined (ENABLE_LVGL_V8_RGB565_SWAP) && (ENABLE_LVGL_V8_RGB565_SWAP == 1)
...
#else       /*LV_MEM_CUSTOM*/
    #define LV_MEM_CUSTOM_INCLUDE "tkl_memory.h"  /*Header for the dynamic memory function*/
...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "tkl_system.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR (tkl_system_get_millisecond())    /*Expression evaluating to current system time in ms*/
