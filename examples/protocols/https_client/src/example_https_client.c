 ...
 *
 * This file provides an example of how to use the HTTPS client interface provided by the Tuya SDK to send HTTPS
 * requests and handle responses. It includes initializing the SDK, setting up network connections (both WiFi and wired,
